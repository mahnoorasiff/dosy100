...
export function getRecipes2(categoryId){
  const [recipesArray, setrecipesArray]= useState('')
  console.log("entering recipe", categoryId)
  firebase.database().ref('recipes').child(categoryId).on('value', (snapshot) => {
    if (snapshot.val() != undefined && snapshot.val() != null) {
      setrecipesArray(Object.values(snapshot.val()))
          console.log("recipesx",recipesArray)
          return recipesArray;   
        }
  })
